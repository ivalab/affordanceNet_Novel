...
OBJ_CLASSES = ('__background__', 'bowl', 'cup', 'hammer', 'knife', 'ladle', 'mallet', 'mug', 'pot', 'scissors', 'scoop', 'shears', 'spoon', 'shovel', 'tenderizer', 'trowel', 'turner')
AFF_CLASSES = ('', 'GRASPABLE', '', '', 'CONTAINABLE', '', '', '', '', '')
...
def write_pddl(path, list_obj_centroids):
    ...
    objects = '    (:objects arm '
    init =    '    (:init (free arm) '
    goal =    '    (:goal (and (contains bowl knife))))'
